...
<title>Win Win Trái Cây Nhập Khẩu - Đăng nhập quản trị</title>
<!-- base:css -->
<link rel="stylesheet"
						...
						<div class="auth-form-light text-start py-5 px-4 px-sm-5">
							...
							<form class="pt-3" id="FORM_LOGIN">
								...
								<div class="form-group">
									<input type="email" required class="form-control form-control-lg" id="EMAIL" placeholder="Email">
								</div>

								<div class="form-group">
									<input type="password" required class="form-control form-control-lg" id="PASSWORD" placeholder="Mật khẩu">
								</div>
								...
								<div class="my-2 d-flex justify-content-between align-items-center">
									...
									<a id="BTN_QUYEN_MAT_KHAU" href="javascript:function() { return false; }" class="auth-link text-black">Quên mật khẩu?</a>
								</div>

								<div class="my-3">
									<button class="btn btn-block btn-info btn-lg font-weight-medium auth-form-btn w-100" type="submit">ĐĂNG NHẬP</button>
								</div>
								...
								<!-- <div class="text-center mt-4 font-weight-light">
									Bạn không có tài khoản? <a href="{{ url('/admin/register') }}" class="text-primary">Tạo tài khoản</a>
								</div> -->
							</form>
						</div>
					</div>
