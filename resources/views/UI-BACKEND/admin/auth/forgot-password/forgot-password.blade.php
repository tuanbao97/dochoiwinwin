...
<title>Win Win Trái Cây Nhập Khẩu - Quên mật khẩu</title>
<!-- base:css -->
<link rel="stylesheet"
				...
				<div class="row w-100 mx-0">
					<div class="col-lg-4 mx-auto" style="max-width: 500px;">
						<div class="auth-form-light text-start py-5 px-4 px-sm-5">
							...
							<h6 class="font-weight-light">Nhập địa chỉ email để reset mật khẩu:</h6>
							<form class="pt-3" id="FORM_FORGOT_PASSWORD">
								...
								<div class="my-3">
									<button class="btn btn-block btn-info btn-lg font-weight-medium auth-form-btn w-100" type="submit">RESET MẬT KHẨU</button>
								</div>
								...
								<div class="text-center mt-4 font-weight-light">
									<a href="{{ url('/admin/login') }}" class="text-primary">Quay trở về trang Login</a>
								</div>
							</form>
						</div>
					</div>
